...
test("user can log in and edit a board", async({page}) => {
    //login
        ...
        await boardColumn.getByTestId("board-edit-button").click()

        await page.getByTestId("edit-board-title-input").clear()
        await page.getByTestId("edit-board-description-input").clear()

        await page.getByTestId("edit-board-title-input").fill("E2E Board Title")
        await page.getByTestId("edit-board-description-input").fill("E2E Board Description")

        await page.getByTestId("edit-board-update-button").click()

        await expect(page.getByText("E2E Board Title")).toBeVisible()
        await expect(page.getByText("E2E Board Description")).toBeVisible()
})